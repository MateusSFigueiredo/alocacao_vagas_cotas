...
# Criar funções preenche_ mod _ c2 (c2 = concorrencia conc, AC primeiro, modelo 2)
...
# Rodar funções preenche_ mod _ c2 (c2 = concorrencia conc AC primeiro, modelo 2)

if(isFALSE(exists("aprovados_A0")))  {preenche_A0_c2()} # AC primeiro
if(isFALSE(exists("aprovados_L01"))) {preenche_L01_c2()} # cotas depois
...
analise_v_c2$bxa <- sum(analise_v_c2$L01, analise_v_c2$L02, # soma de baixa renda
...
# ==============================================================================
# Guarda aprovados_c2
convocados_c2 <- aprovados_c2

# ==============================================================================

# Limpeza

rm(list=ls(pattern="^aprovados_L")) # objetos que começam com "aprovados"
